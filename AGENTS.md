...
- [`Pika-Labs/Pika-Editor`](https://github.com/Pika-Labs/Pika-Editor) — PikaAgentEditor, a standalone agent-first video editor on the Pika MCP. Apache-2.0; its own repo (linked from the root README's "Standalone projects" section), not a folder here.
